...
<body>
  ...
  <main>
    <section id="popular-apps">
      <div class="section-overview overview">
        ...
        <p>Explore the most popular social media apps that teenagers are using today. Learn about their features, benefits, and how they can impact your teen's digital life. Discover privacy tips and safety guidelines to help ensure your teen's online experience is secure and positive.</p>
      </div>
      <?php
      ...
      ?>
          <div class="app-row">
            <div class="app-logo"><img src="<?php echo "images\\" . $row['logo']; ?>"></div>
            <div class="app-name"><?php echo $row['name']; ?></div>
            <a href="<?php echo $row['link']; ?>" class="app-link" target="_blank">Visit App</a>
            <a href="<?php echo $row['privacylink']; ?>" class="privacy-link" target="_blank">Privacy Policy</a>
          </div>
      <?php
        }
      }
  ...
  <footer>
    <p class="here"><b>You are here: Popular Apps</b></p>
